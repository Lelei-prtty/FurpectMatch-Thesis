        ...
        <div className="grid gap-6 lg:grid-cols-[420px_auto]">
          <div className="bg-indigo-600 p-8 sm:p-10 text-white">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <p className="text-sm uppercase tracking-[0.25em] text-indigo-200">Join as a Pet Guardian</p>
            ...
            <div className="mt-10 space-y-8">
              <div className="rounded-3xl bg-white/10 p-5">
                <p className="text-sm font-semibold text-indigo-100">Browse pets</p>
                <p className="mt-2 text-sm text-indigo-200">Explore available animals and find the right match.</p>
              </div>
              <div className="rounded-3xl bg-white/10 p-5">
                <p className="text-sm font-semibold text-indigo-100">Save favorites</p>
                <p className="mt-2 text-sm text-indigo-200">Keep pet profiles you love in one place.</p>
              </div>
              <div className="rounded-3xl bg-white/10 p-5">
                <p className="text-sm font-semibold text-indigo-100">Apply to adopt</p>
                <p className="mt-2 text-sm text-indigo-200">Send applications and connect directly with providers.</p>
              </div>
            </div>
          </div>
          <div className="p-8 sm:p-10">
            <div className="space-y-6">
              <div>
                <p className="text-sm uppercase tracking-[0.25em] text-indigo-600">Guardian registration</p>
              ...
              <p className="text-sm text-gray-500">
                ...
                <Link to="/guardian/login" className="font-semibold text-indigo-600 hover:text-indigo-700">
                  Log in as Guardian
                </Link>
              </p>
              <p className="text-sm text-gray-500">
                Need provider access?{' '}
                <Link to="/provider/register" className="font-semibold text-indigo-600 hover:text-indigo-700">
