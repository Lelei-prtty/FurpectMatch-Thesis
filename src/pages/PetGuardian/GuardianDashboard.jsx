      ...
      <div className="flex-1 overflow-hidden">
        ...
        <main className="h-[calc(100vh-88px)] overflow-auto px-6 py-6">
          ...
          {activeTab === 'applications' && (
            <section className="space-y-6">
              <div className="rounded-3xl bg-white p-6 shadow-sm border border-[#CACACA]">
                <h2 className="text-xl font-semibold text-[#683B0D]">My Applications</h2>
                <p className="mt-2 text-sm text-[#989797]">Review the adoption applications and next steps.</p>
              </div>
          ...
          {activeTab === 'messages' && (
            <section className="space-y-6">
              <div className="rounded-3xl bg-white p-6 shadow-sm border border-[#CACACA]">
                <h2 className="text-xl font-semibold text-[#683B0D]">My Messages</h2>
                <p className="mt-2 text-sm text-[#989797]">View conversations with pet providers.</p>
              </div>
              <div className="space-y-4">
