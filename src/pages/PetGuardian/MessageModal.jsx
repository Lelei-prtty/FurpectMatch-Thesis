          ...
          <div className="flex flex-col gap-4">
            <div className="space-y-4 rounded-[32px] bg-gray-100 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="self-end rounded-3xl bg-blue-600 px-5 py-4 text-sm font-semibold text-white">
            ...
            <div className="rounded-[32px] bg-white p-4 shadow-sm">
              ...
              <div className="mt-3 flex gap-3">
                <input
                  ...
                  className="flex-1 rounded-3xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-900 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                />
                <button
                  type="button"
