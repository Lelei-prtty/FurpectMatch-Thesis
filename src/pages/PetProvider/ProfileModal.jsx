            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <aside className="col-span-1 space-y-6 lg:col-span-1">
                <div className="rounded-2xl border border-gray-100 bg-white p-6 flex flex-col items-center gap-4">
                  ...
                  <label htmlFor="profilePic" className="inline-flex w-full items-center justify-center rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">
                    Change Photo
                  </label>
                </div>
                  ...
                  <div className="rounded-2xl border border-gray-100 bg-white p-6">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <label className="block">
                        ...
                        <input value={fullName} onChange={(e) => setFullName(e.target.value)} className="mt-2 w-full rounded-lg border border-gray-200 px-4 py-3 outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-50" />
                      </label>
                      <label className="block">
                        <span className="text-sm font-medium text-gray-700">Email</span>
                        <input value={email} onChange={(e) => setEmail(e.target.value)} className="mt-2 w-full rounded-lg border border-gray-200 px-4 py-3 outline-none bg-gray-50" />
                      </label>
                      <label className="block">
                        <span className="text-sm font-medium text-gray-700">Phone Number</span>
                        <input value={phone} onChange={(e) => setPhone(e.target.value)} className="mt-2 w-full rounded-lg border border-gray-200 px-4 py-3 outline-none" />
                      </label>
                      <label className="block">
                        <span className="text-sm font-medium text-gray-700">Role</span>
                        <input value={role} readOnly className="mt-2 w-full rounded-lg border border-gray-200 px-4 py-3 outline-none bg-gray-50" />
                      </label>
                    </div>

                    <label className="block mt-4">
                      <span className="text-sm font-medium text-gray-700">Bio</span>
                      <textarea value={bio} onChange={(e) => setBio(e.target.value)} maxLength={250} className="mt-2 h-28 w-full rounded-lg border border-gray-200 px-4 py-3 outline-none" />
                      <div className="mt-2 text-right text-xs text-gray-400">{bio.length}/250</div>
                    </label>

                    <div className="mt-6 flex justify-end">
                      <button type="submit" className="rounded-full bg-purple-600 px-6 py-2 text-sm font-semibold text-white hover:bg-purple-700">Save Changes</button>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Receive updates about your applications</p>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Get notified when new pets match your preferences</p>
                        </div>
                        <label className="inline-flex items-center">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Receive helpful tips and pet care resources</p>
                        </div>
                        <label className="inline-flex items-center">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Receive news and special offers</p>
                        </div>
                        <label className="inline-flex items-center">
                  ...
                  <div className="rounded-2xl border border-gray-100 bg-white p-6">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <label className="block">
                        ...
                        <select value={profileVisibility} onChange={(e) => setProfileVisibility(e.target.value)} className="mt-2 w-full rounded-lg border border-gray-200 px-4 py-3 outline-none">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-xs text-gray-400">Allow others to see your email</p>
                          </div>
                          <label className="inline-flex items-center">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-xs text-gray-400">Allow others to see your phone number</p>
                          </div>
                          <label className="inline-flex items-center">
                        ...
                        <div className="mt-2 flex items-center justify-between border-t pt-3">
                          <div>
                            ...
                            <p className="text-xs text-gray-400">Permanently delete your account and all of your data.</p>
                          </div>
