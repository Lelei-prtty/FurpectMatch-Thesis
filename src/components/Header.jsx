    ...
    <header className="bg-white border-b border-gray-200">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-8">
          <a href="#" className="text-gray-700 hover:text-gray-900 font-medium">For Pet Guardians</a>
          <a href="#" className="text-gray-700 hover:text-gray-900 font-medium">For Pet Providers</a>
        ...
        <div className="flex gap-3">
          <button className="px-6 py-2 border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium">
            Log In
          </button>
